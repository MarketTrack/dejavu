...
alias python=/home/ubuntu/.local/share/virtualenvs/dejavu-YUUNiS5o/bin/python

###########
# Fingerprint files of extension mp3 in the ./mp3 folder
/home/ubuntu/.local/share/virtualenvs/dejavu-YUUNiS5o/bin/python dejavu.py -f ./mp3/ mp3
...
/home/ubuntu/.local/share/virtualenvs/dejavu-YUUNiS5o/bin/python run_tests.py \
	--secs 5 \
	--temp ./temp_audio \
